          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
            <div className="flex items-center gap-4 flex-1">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center flex-shrink-0">
                <FiUsers className="w-7 h-7 sm:w-8 sm:h-8" />
              </div>
          ...
          <div className="p-8 sm:p-12 md:p-16">
            <div className="max-w-md mx-auto text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                Your customer list is empty. When customers interact with your AI voice agent through calls, SMS, or WhatsApp, they will automatically appear here.
              </p>
